...
App.RedirectRoute = Ember.Route.extend({
  redirect: function(model) {
    ...
    lib = parts[1];
    matchedPath = parts[2];
    newUrl = "http://addepar.github.io/" + lib + "/#";
    switch (lib) {
      case 'ember-table':
        newUrl += matchedPath;
        break;
